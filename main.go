...
.upgradeTitle{ font-size:14px; font-weight:800; margin-bottom:12px; }
.bottomNav{
 position:fixed;
...
<div id="generatorTab" class="section">
 ...
 <div class="coinArea">
  <svg id="coin" class="coin" viewBox="0 0 500 500">
   ...
   <circle cx="250" cy="250" r="220" fill="none" stroke="#b0c4de" stroke-width="10"/>
   <circle cx="250" cy="250" r="200" fill="none" stroke="url(#coinGrad)" stroke-width="6"/>
   <circle cx="250" cy="250" r="180" fill="#05101c" stroke="#00ff87" stroke-width="2"/>
   ...
   <g filter="url(#glow)">
     <path d="M 170 180 L 330 180 L 170 320 L 330 320" fill="none" stroke="#ffffff" stroke-width="22" stroke-linecap="round" stroke-linejoin="round"/>
     <path d="M 170 180 L 330 320 M 330 180 L 170 320" fill="none" stroke="#ffffff" stroke-width="22" stroke-linecap="round" stroke-linejoin="round"/>
   </g>
  </svg>
 </div>
 <div class="energyRow">
...
<div id="walletTab" class="section hidden">
 ...
 <div class="delete-section">
  <button id="deleteAccountBtn" class="btn btn-danger" style="width:100%;">Șterge contul</button>
 </div>
 <h3 style="margin-top:24px; margin-bottom:14px;">Withdrawal History</h3>
 <table style="width:100%; border-collapse:collapse;">
  <thead><tr><th style="text-align:left; padding:12px; border-bottom:1px solid rgba(255,255,255,.08);">Date</th><th>Amount</th><th>Asset</th><th>Status</th></tr></thead>
  <tbody id="withdrawTable">
   <tr><td style="padding:12px;">2026-06-01</td><td>120000</td><td>TON</td><td style="color:#ffd166;">În așteptare</td></tr>
   <tr><td style="padding:12px;">2026-05-24</td><td>50000</td><td>TON</td><td style="color:#00ff87;">Finalizat</td></tr>
  </tbody>
 </table>
</div>
...
<div id="rankTab" class="section hidden">
 ...
 <div style="margin-top:20px; background: rgba(157,77,255,.08); border: 1px solid rgba(157,77,255,.3); border-radius:20px; padding:18px;">
  ...
  <div id="myRank" style="margin-top:8px; font-size:30px; font-weight:900;">#-</div>
...
async function updateLeaderboardUI() {
  var entries = await fetchLeaderboard();
